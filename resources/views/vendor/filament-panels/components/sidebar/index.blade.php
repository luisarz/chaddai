...
>
    ...
    <nav
        class="fi-sidebar-nav flex-grow flex flex-col gap-y-7 overflow-y-auto overflow-x-hidden px-2 py-6"
    ...
    >
        ...
        <ul class="fi-sidebar-nav-groups -mx-2 flex flex-col gap-y-5">
